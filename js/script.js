...
navMobile.innerHTML = `
            ...
            <div class="promo__header__nav__menu__item">
                <a class="promo__link__close" href="#services">Services</a>
                <div class="promo__header__nav__menu__item__circle"></div>
            </div>
            <div class="promo__header__nav__menu__item">
                <a class="promo__link__close" href="#about">About us</a>
                <div class="promo__header__nav__menu__item__circle"></div>
            </div>
            <div class="promo__header__nav__menu__item">
                <a class="promo__link__close" href="#security">Security</a>
                <div class="promo__header__nav__menu__item__circle"></div>
            </div>
            <div class="promo__header__nav__menu__item">
                <a class="promo__link__close" href="#cases">Cases</a>
                <div class="promo__header__nav__menu__item__circle"></div>
            </div>
            <div class="promo__header__nav__menu__item">
                <a class="promo__link__close" href="#team">Team</a>
                <div class="promo__header__nav__menu__item__circle"></div>
            </div>
            <div class="promo__header__nav__menu__item">
                <a class="promo__link__close" href="#contacts">Contacts</a>
                <div class="promo__header__nav__menu__item__circle"></div>
            </div>
`;
